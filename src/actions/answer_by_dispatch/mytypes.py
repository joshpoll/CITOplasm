...
from src.tools.answer_by_computation import answer_by_computation
from src.tools.answer_by_search import answer_by_search
from src.deduction.answer_by_cot_reasoning import answer_by_reasoning
